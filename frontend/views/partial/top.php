<div class="slide-menu-element mobile-only" ng-class="{'active':site.slideMenuState}" ng-swipe-left="site.setState(false)">
	<nav class="menu">
		...
		<a class="item" ng-click="site.setMenuState(false); site.scrollBodyTo('section#section4')">фитнес-клуб&nbsp;</a>
	</nav>
</div>
<div class="content">
			...
			<div class="content-wrapper">
				<header class="header-element">
					<div class="mobile-only">
						<div class="slide-dummy-element" ng-swipe-right="site.setState(true)"></div>
						<div class="row">
							<div class="col s12">

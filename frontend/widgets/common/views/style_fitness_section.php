					...
					<div class="right-content-block-element">
						...
						<div class="card-element">
							...
							<section class="content">
								<p>
									Тренажерный зал, оснащенный современными спортивными тренажерами;
									Кардио-тренажеры Intenza;
									Групповые программы (пилатес, йога, танцы);
									Бассейн с зонами для отдыха и релаксации;
									Персональный тренинг;
									Фитнес бар со спортивным питанием и коктейлями;
									Бесплатный паркинг.
								</p>
							</section>
						</div>
